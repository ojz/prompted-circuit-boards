...
| [modules/drive-filter/SPEC.md](modules/drive-filter/SPEC.md) | Drive Filter: distortion into resonant HPF and resonant LPF in a normalled series chain, the three-by-five panel, normalled breaks and ideal DSP transfer functions. |
