...
Generated by `toolkit/src/Designs/Mult.hs` and `Designs/MultPanel.hs`
(`cd toolkit && cabal run pcbgen -- all`), verified by `toolkit/check.sh mult`
and `toolkit/check.sh mult/panel`, fab bundle by `toolkit/fab.sh`. Do not edit
